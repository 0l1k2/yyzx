...
# CREATE DATABASE IF NOT EXISTS yyzx DEFAULT CHARSET utf8mb4 COLLATE utf8mb4_general_ci;
# USE yyzx;
#
# CREATE TABLE user (
...
#     is_deleted INT COMMENT '逻辑删除标记（0：显示 ，1：隐藏）'
...
#     start_date DATE COMMENT '床位起始日期',
#     end_data DATE COMMENT '床位结束日期',
#     bed_detail VARCHAR(255) COMMENT '床位详细信息',
#     is_deleted INT COMMENT '逻辑删除标记（0：显示 ，1：隐藏）'
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='床位分配记录';
#
# CREATE TABLE room (
#     id INT NOT NULL PRIMARY KEY COMMENT '主键',
#     room_floor VARCHAR(10) NOT NULL COMMENT '房间楼层',
...
# CREATE TABLE menu (
#     id INT NOT NULL PRIMARY KEY COMMENT '主键',
#     menus_index VARCHAR(5) COMMENT '一级菜单索引',
...
#     food_type VARCHAR(20) COMMENT '食品类型',
#     price DECIMAL(10,2) COMMENT '价格',
#     food_image VARCHAR(100) COMMENT '图片路径',
#     is_halal INT COMMENT '是否清真'
...
#     meal_tyle INT COMMENT '食品类型(1:早餐 2:午餐 3:晚餐)',
#     taste VARCHAR(30) COMMENT '口味(多糖多盐少糖少盐)',
#     is_deleted INT NOT NULL COMMENT '逻辑删除标记（0：显示 ，1：隐藏）'
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='膳食安排';
#
# CREATE TABLE preference (
#     id INT NOT NULL PRIMARY KEY COMMENT '主键',
#     customer_id INT NOT NULL COMMENT '顾客ID',
#     preferences VARCHAR(50) COMMENT '饮食喜好',
#     attention VARCHAR(50) COMMENT '注意事项',
#     remarks VARCHAR(50) COMMENT '备注',
#     is_deleted INT NOT NULL COMMENT '逻辑删除标记（0：显示 ，1：隐藏）'
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='顾客偏好';
#
# CREATE TABLE nursecontent (
#     id INT NOT NULL PRIMARY KEY COMMENT '主键',
#     serial_number VARCHAR(20) NOT NULL COMMENT '编号',
#     nursing_name VARCHAR(50) NOT NULL COMMENT '名称',
#     service_price VARCHAR(50) NOT NULL COMMENT '价格',
#     message VARCHAR(100) COMMENT '描述',
#     status INT NOT NULL COMMENT '状态（1：启用 2：停用）',
#     execution_cycle VARCHAR(20) COMMENT '执行周期',
#     execution_times VARCHAR(20) COMMENT '执行次数',
#     is_deleted INT NOT NULL COMMENT '逻辑删除标记（0：显示 ，1：隐藏）'
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='护理内容';
#
# CREATE TABLE nurselevel (
#     id INT NOT NULL PRIMARY KEY COMMENT '主键',
#     level_name VARCHAR(20) NOT NULL COMMENT '护理等级',
#     level_status INT COMMENT '级别状态（1:启用 2：停用）',
#     is_deleted INT NOT NULL COMMENT '逻辑删除标记（0：显示 ，1：隐藏）'
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='护理等级';
#
# CREATE TABLE nurselevelitem (
#     id INT NOT NULL PRIMARY KEY COMMENT '主键',
#     level_id INT NOT NULL COMMENT '关联护理登记',
#     item_id INT NOT NULL COMMENT '关联护理项目'
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='护理等级项目关系';
#
...
#     nursingcontent VARCHAR(255) COMMENT '护理内容',
...
#     customer_sex INT NOT NULL COMMENT '客户性别（1：男 0：女）',
...
#     building_no VARCHAR(10) NOT NULL COMMENT '所属楼房',
#     check_date DATE NOT NULL COMMENT '入住时间',
#     expiration_data DATE NOT NULL COMMENT '合同到期时间',
#     bed_id INT NOT NULL COMMENT '床位',
#     psychosomatic_state VARCHAR(255) COMMENT '身心健康',
#     attention VARCHAR(255) COMMENT '注意事项',
#     birthday DATE COMMENT '生日',
#     height VARCHAR(20) COMMENT '身高',
#     weight VARCHAR(20) COMMENT '体重',
#     blood_type VARCHAR(20) NOT NULL COMMENT '血型',
#     filepath VARCHAR(255) NOT NULL COMMENT '头像',
#     user_id INT NOT NULL COMMENT '健康管家ID',
#     level_id INT COMMENT '护理登记',
#     family_member VARCHAR(20) COMMENT '家属',
#     is_deleted INT NOT NULL COMMENT '逻辑删除标记（0：显示 ，1：隐藏）'
...
#     item_id INT NOT NULL COMMENT '护理项目ID',
#     customer_id INT NOT NULL COMMENT '客户ID',
#     level_id INT COMMENT '护理级别编号',
#     nurse_number INT NOT NULL COMMENT '购买数量',
#     buy_time DATE NOT NULL COMMENT '购买服务日期',
#     maturity DATE NOT NULL COMMENT '服务到期日期',
#     is_deleted INT NOT NULL COMMENT '逻辑删除标记（0：显示 ，1：隐藏）'
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='客户护理服务';
#
...
#     actualreturntime DATE COMMENT '实际回院时间',
#     escorted VARCHAR(50) COMMENT '陪同人',
#     relation VARCHAR(50) COMMENT '与客户关系',
#     escortedtel VARCHAR(20) COMMENT '陪同人电话',
#     auditstatus INT NOT NULL COMMENT '审批状态(1:同意 2：拒绝)',
#     auditperson VARCHAR(20) NOT NULL COMMENT '审批人',
#     audittime DATE NOT NULL COMMENT '审批时间',
#     remarks VARCHAR(100) COMMENT '备注',
#     is_deleted INT NOT NULL COMMENT '逻辑删除标记（0：显示 ，1：隐藏）'
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='外出记录';
#
...
#     retreatreason VARCHAR(100) COMMENT '退住原因',
#     auditstatus INT NOT NULL COMMENT '审批状态(1:同意 2：拒绝)',
#     auditperson VARCHAR(20) NOT NULL COMMENT '审批人',
#     audittime DATE NOT NULL COMMENT '审批时间',
#     remarks VARCHAR(100) COMMENT '备注',
#     is_deleted INT NOT NULL COMMENT '逻辑删除标记（0：显示 ，1：隐藏）'
# ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='退住记录';
u
use yyzx;
/*
...
show tables;
 select
       c.id,           c.is_deleted,c.customer_name,       c.customer_age,c.customer_sex,
       c.idcard,       c.room_no,   c.building_no,         c.checkin_date,c.expiration_date,
       c.contact_tel,  c.bed_id,    c.psychosomatic_state, c.attention,   c.birthday,
       c.height,       c.weight,    c.blood_type,          c.filepath,    c.user_id,
       c.family_member,u.nickname,  c.level_id,            b.bed_no,      n.level_name
from customer c
    left join nurselevel n on c.level_id = n.id
         left join bed b on c.bed_id = b.id
         left join user u on c.user_id = u.id;

select count(1) from customernurseitem cni,customer where cni.custormer_id = customer.id and cni.is_deleted = 0


select c.id, c.is_deleted, c.customer_name, c.customer_age, c.customer_sex, c.idcard, c.room_no, c.building_no, c.checkin_date, c.expiration_date, c.contact_tel, c.bed_id, c.psychosomatic_state, c.attention, c.birthday, c.height, c.weight, c.blood_type, c.filepath, c.user_id, c.family_member, u.nickname, c.level_id, b.bed_no, n.level_name from customer c left join nurselevel n on c.level_id = n.id left join bed b on c.bed_id = b.id left join user u on c.user_id = u.id WHERE c.user_id = 1 and c.is_deleted = 0 order by c.id desc limit 0,5

select c.id, c.is_deleted, c.customer_name, c.customer_age, c.customer_sex, c.idcard, c.room_no, c.building_no, c.checkin_date, c.expiration_date, c.contact_tel, c.bed_id, c.psychosomatic_state, c.attention, c.birthday, c.height, c.weight, c.blood_type, c.filepath, c.user_id, c.family_member, u.nickname, c.level_id, b.bed_no, n.level_name from customer c left join nurselevel n on c.level_id = n.id left join bed b on c.bed_id = b.id left join user u on c.user_id = u.id WHERE c.is_deleted = 0 order by c.id desc
