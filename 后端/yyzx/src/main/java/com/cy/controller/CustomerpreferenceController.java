...
public class CustomerpreferenceController {
    ...
    @PostMapping("/getCustomerpreferencesVo")
    public ResultVo getCustomerpreferencesVo(@RequestBody CustomerpreferenceDto customerpreferenceDto){
        return customerpreferenceService.selectCustomerpreferencesVo(customerpreferenceDto);
        }
